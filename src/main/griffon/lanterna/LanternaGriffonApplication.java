 ...
 * <p/>
 * Windows in a Lanterna application should be handled by a {@code WindowManager}, which in turn requires a concrete implementation of the
 * {@code WindowDisplayHandler} to be available on the target application.
 *
 * @author Andres Almiray
 * @see griffon.lanterna.WindowManager
...
public interface LanternaGriffonApplication extends GriffonApplication {
     ...
     * <p/>
     * Every {@code LanternaGriffonApplication} must have a non-null instance.
     *
