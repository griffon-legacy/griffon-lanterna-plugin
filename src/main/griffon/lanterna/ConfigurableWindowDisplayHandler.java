 ...
 * <p/>
 * This is the default {@code WindowDisplayHandler} used by {@code LanternaApplication}. It expects a configuration entry in
...
public class ConfigurableWindowDisplayHandler implements WindowDisplayHandler {
    ...
    public void show(Window window, LanternaGriffonApplication application) {
        ...
        String name = windowManager.findWindowName(window);
    ...
    private Map<String, Object> windowManagerBlock(GriffonApplication application) {
        Map<String, Object> block = (Map<String, Object>) ConfigUtils.getConfigValue(application.getConfig(), "lanterna.windowManager");
