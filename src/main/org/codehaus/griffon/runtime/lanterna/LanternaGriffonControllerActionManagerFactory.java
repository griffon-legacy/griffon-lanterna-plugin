 ...
 */
public class LanternaGriffonControllerActionManagerFactory implements GriffonControllerActionManagerFactory {
    public GriffonControllerActionManager create(GriffonApplication app) {
        return new LanternaGriffonControllerActionManager(app);
    }
}
